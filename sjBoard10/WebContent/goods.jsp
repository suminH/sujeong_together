...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="goodsAction.jsp">
				<table class="table table-striped"
					style="text-align: center; border: 1px;">
					<thead>
						<tr>
							<th colspan="2"
								style="background-color: #3182B5; text-align: center;">상품
								등록하기</th>
						</tr>
					</thead>
					...
					<tbody>
						<tr>
							...
							<td><input type="text" class="form-control"
								placeholder="상품 이름" name="goods_name" maxlength="50"></td>
						</tr>
						<tr>
							<td align="center">상품 분류</td>
							<td align="left">패딩<input type="radio" name="goods_type"
								value="padding"> 
								후드<input type="radio" name="goods_type" value="hoodie">
								자켓<input type="radio" name="goods_type" value="jacket">
						</tr>
						<tr>
							<td align="center">상품 가격</td>
							<td><input type="text" class="form-control"
								placeholder="상품 가격" name="goods_price" maxlength="50"></td>
						</tr>
